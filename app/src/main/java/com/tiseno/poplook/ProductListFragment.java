...
//        String action="Products/search/keyword/"+search+"/lang/1/shop/"+SelectedShopID+"/num_page/"+numberPages+"/sort_options/"+sortType+"?apikey="+apikey;
...

    {
        ...
        System.out.println("get sort here = " + sortType);
        //
        String action="Products/filterCategoryProducts?apikey="+apikey+"&shop="+SelectedShopID+"&category="+catID+"&color="+colourFilter+"&product_attribute="+sizeFilter+"&num_page="+numberPages+"&sort_options="+sortType+"&category_filter="+catID_API;
        if(firstLoad) {
            WebServiceAccessGet callws = new WebServiceAccessGet(getActivity(), this);
