...
//                    } else {
                    ...
                    try {
                        ...
                        for(int i = 0;i< jsonArr3.length();i++)
                        {
                            ...
                            System.out.println("get payment type = " + paymentType);
...
//                            }
    ...
    private void refreshRecycleView()
    {
        ...
        else
        {
            ...
            shippingMethodInfoTV.setText(listArray_carrier.get(SelectedCarrierPosition).getcarrierName());
        }
...
//                    if(onlineBankingNP.getValue() == 1)
//                    {
//                        PaymentIDForIPay88fEWalletLL = "6";
//                    }
//                    else if(onlineBankingNP.getValue() == 2)
//                    {
//                        PaymentIDForIPay88 = "20";
//                    }
//                    else if(onlineBankingNP.getValue() == 3)
//                    {
//                        PaymentIDForIPay88 = "14";
//                    }
//                    else if(onlineBankingNP.getValue() == 4)
//                    {
//                        PaymentIDForIPay88 = "10";
//                    }
//                    else if(onlineBankingNP.getValue() == 5)
//                    {
//                        PaymentIDForIPay88 = "8";
//                    }
//                    else if(onlineBankingNP.getValue() == 6)
//                    {
//                        PaymentIDForIPay88 = "15";
//                    }
//                    else if(onlineBankingNP.getValue() == 7)
//                    {
//                        PaymentIDForIPay88 = "102";
//                    }
//                    else if(onlineBankingNP.getValue() == 8)
//                    {
//                        PaymentIDForIPay88 = "103";
//                    }
//                    else if(onlineBankingNP.getValue() == 9)
//                    {
//                        PaymentIDForIPay88 = "16";
//                    }
//                    else if(onlineBankingNP.getValue() == 10)
//                    {
//                        PaymentIDForIPay88 = "31";
//                    }
//                    else if(onlineBankingNP.getValue() == 11)
//                    {
//                        PaymentIDForIPay88 = "100";
//                    }
//                    else if(onlineBankingNP.getValue() == 12)
//                    {
//                        PaymentIDForIPay88 = "22";
//                    }
//                    else if(onlineBankingNP.getValue() == 13)
//                    {
//                        PaymentIDForIPay88 = "2";
//                    }
