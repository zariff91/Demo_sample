 ...
 */
public class WebServiceAccessDeleteWithoutLoading extends AsyncTask<RequestBody, Void, JSONObject> {
    ...
    public WebServiceAccessDeleteWithoutLoading(Context context, AsyncTaskCompleteListener<JSONObject> listener){
