...
//                            fragmentTransaction.commit();
                            ...
                            String apikey =pref.getString("apikey","");
                            String shippingAPI="Carts/OrderStep3?apikey="+apikey+"&id_cart="+CartID+"&id_address_delivery="+deliveryAddItem.getaddressID()+"&id_carrier="+0+"&device_type=android&app_version="+appVersion;
